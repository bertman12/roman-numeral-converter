...
An algorithm that partitions an input number into an array. Each element is a multiple of a specific roman numeral. 
This array is then input into a function which determines which roman numerals are put inside a new array based on the multiples from the input array.
The program also features a user interface made with HTML, CSS and JS.


$==My initial thought process on the solution, followed by the code implementation.==$
...
THEN PUT ARRAY IN ALGORITHM WHICH RETURNS A ROMAN NUMERAL BASED OFF THE POSITION AND VALUE 
...
THE ALGORITHM WOULD START FROM THE BEGINNING OF THE ARRAY AND WORK TO THE END WHILE SPITTING OUT ROMAN NUMERALS
    ...
    FOR NUMBERS WHOSE DIVISION WILL RESULT IN 4 OR 9 WE WILL PUSH A ROMAN NUMERAL INTO THE POSITION BEFORE.
    IT WILL BE SUBTRACTED FROM THE LARGER ROMAN NUMERAL FOLLOWING IT.
    BASED ON OUR RULE OF SUBTRACTING ROMAN NUMERALS ON MULTIPLES OF 5

    WE'LL GET THE ROMAN NUMERAL THAT IS THE LARGEST IN ITS NUMBER RANGE 
    (EX:THE NUMBER 400 HAS 500 AS ITS LARGEST NUMBER IN ITS ROMAN NUMERAL RANGE FROM 100 TO 500)
    TAKE THE GREATEST ROMANL NUMERAL IN THE APPROPRIATE BRACKET AND THEN TAKE THE LOWEST ROMAN NUMERAL IN ITS RANGE BRACKET 
    PLACE THE LOWEST BEFORE THE GREATEST

    FOR NUMBERS WHO ARENT A MULTIPLE OF 5 AND ARENT 4 OR 9
    WE WILL BRANCH OFF INTO ANOTHER ALGORITH THAT WILL ADD THE LOWER ROMAN NUMERAL FROM ITS NUMBER BRACKET AN APPROPRIATE 
    AMOUNT OF TIMES. THESE WILL BE PUSHED INTO THE FINAL ARRAY OF ROMAN NUMERALS

    THE ALGORITHM WILL DETERMINE THE NUMBER BRACKET RANGES OF THE INPUT AND THE REMAINDER USING A SWITCH STATEMENT
    ...
    THE POSITION OF ROMAN NUMERALS WILL HAVE THE CORRECT ROMAN NUMERALS AVAILABLE BASED OFF THE POSITION OF THE VALUE IN OUR COMPUTED INPUT NUMBER ARRAY
    EX WE HAVE A NUMBER 5 IN THE FIRST POSITION OF OUR COMPUTED ARRAY, THEREFORE WE WILL ONLY CHECK THE FIRST ROMAN NUEMRAL SUB ARRAY 
