...
THE ALGORITHM WOULD START FROM THE BEGINNING OF THE ARRAY AND WORK TO THE END WHILE SPITTING OUT ROMAN NUMERALS
    ...
    THE ROMAN NUMERAL ARRAY WILL BE SECTIONED INTO SUB ARRAYS THAT WILL EACH HAVE THE RIGHT ROMAN NUMBERAL BASED
...
let inputNumber = 9;
let computedInputNumber = [];
let computedRomanNumerals = [];
let convertedNumber = "";
...
computedInputNumber = computeInput(inputNumber);
computedRomanNumerals = createRomanNumerals(computedInputNumber);
convertedNumber = computedRomanNumerals.join('');
console.log(computedInputNumber);
console.log(computedRomanNumerals);
